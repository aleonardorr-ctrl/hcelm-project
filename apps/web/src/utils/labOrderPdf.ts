...
export function generateLabOrderPdf({
  institution,
  patient,
  formData,
  labOrder,
  ...
  if (!patient) {
    alert('Seleccione un paciente antes de generar la orden de laboratorio.');
    return;
  }
  ...
  <html>
    ...
    <body>
      ...
      <div class="section">
        ...
        <p class="field">
          <span class="label">Prioridad:</span> ${safeText(labOrder?.priority || 'Rutina')}
        </p>
      </div>
      ...
      <div class="section">
        ...
        <div class="text-block">
          ${safeText(labOrder?.clinicalInfo || formData?.anamnesisActual)}
        </div>
      </div>
      ...
      <div class="section">
        ...
        <div class="exam-list">
          ${safeText(labOrder?.tests)}
        </div>
      </div>

      <div class="section">
        <div class="section-title">Observaciones / indicaciones para laboratorio</div>

        <div class="text-block">
          ${safeText(labOrder?.observations)}
        </div>
      </div>
