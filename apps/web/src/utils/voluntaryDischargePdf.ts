...
export function generateVoluntaryDischargePdf({
  ...
  if (!patient) {
    alert('Seleccione un paciente antes de generar el alta voluntaria.');
    return;
  }
    ...
    <body>
      ...
      <div class="section">
        ...
        <div class="text-block">
          ${destinationDetails?.voluntariaResumenClinico || formData?.anamnesisActual || ''}
        </div>
      </div>

      <div class="section">
        <div class="section-title">Motivo del alta voluntaria</div>
        <div class="text-block">
          ${destinationDetails?.voluntariaMotivo || ''}
        </div>
      </div>

      <div class="section">
        <div class="section-title">Riesgos explicados</div>
        <div class="text-block">
          ${destinationDetails?.voluntariaRiesgos || ''}
        </div>
      </div>

      <div class="section">
        <div class="section-title">Responsable / familiar</div>
        <div class="grid">
          <p class="field"><span class="label">Nombre:</span> ${
            destinationDetails?.voluntariaResponsable || ''
          }</p>
          <p class="field"><span class="label">DNI:</span> ${
            destinationDetails?.voluntariaDniResponsable || ''
          }</p>
          <p class="field"><span class="label">Parentesco:</span> ${
            destinationDetails?.voluntariaParentesco || ''
          }</p>
          <p class="field"><span class="label">Teléfono:</span> ${
            destinationDetails?.voluntariaTelefono || ''
          }</p>
        </div>
      </div>
      ...
      <div class="section">
        ...
        <p class="declaration">
          El paciente y/o responsable declara haber recibido información clara sobre su estado clínico,
          diagnóstico probable, riesgos de abandonar o interrumpir la atención médica, alternativas de manejo
          y posibles complicaciones. A pesar de dicha información, solicita el alta voluntaria bajo su responsabilidad,
          dejando constancia de que se le indicaron signos de alarma y la necesidad de retornar ante cualquier deterioro.
        </p>
      </div>
      ...
      <div class="signatures">
        <div class="patient-signature">
          <div class="signature-line">
            Firma paciente / responsable<br/>
            ${destinationDetails?.voluntariaResponsable || patient?.fullName || ''}<br/>
            DNI ${destinationDetails?.voluntariaDniResponsable || patient?.documentNumber || ''}
          </div>
        </div>
      ...
      <div class="note">
        Documento institucional generado desde HCELM. Debe conservarse en la historia clínica del paciente.
      </div>
